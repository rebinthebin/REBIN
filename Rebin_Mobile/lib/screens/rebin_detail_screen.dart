        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  // Durum Badge'i (Arızalı veya Aktif/Deaktif)
                  if (bin.isOutOfOrder)
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          color: WasteTheme.outOfOrderBorderColor,
                          width: 1.5,
                        ),
                      ),
                      child: Row(
              ...
              const SizedBox(height: 16),
              _buildWasteBar('Metal', bin.metal, WasteTheme.metalColor, WasteTheme.metalSoftBg, WasteTheme.metalColor, WasteTheme.metalIcon),
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                print("[Delete] Kutu SQLite'dan kalıcı olarak silindi: ${bin.binId}");
