                  ...
                  children: [
                    SizedBox(
                      ...
                      child: _buildWasteCard(
                        ...
                        softBgColor: WasteTheme.plasticSoftBg,
                        textColor: WasteTheme.plasticColor,
                        icon: WasteTheme.plasticIcon,
                      ),
                    ),
                    SizedBox(
                      width: cardWidth,
                      ...
                      child: _buildWasteCard(
                        ...
                        softBgColor: WasteTheme.paperSoftBg,
                        textColor: WasteTheme.paperColor,
                        icon: WasteTheme.paperIcon,
                      ),
                    ),
                    SizedBox(
                      width: cardWidth,
                      ...
                      child: _buildWasteCard(
                        ...
                        softBgColor: WasteTheme.glassSoftBg,
                        textColor: WasteTheme.glassColor,
                        icon: WasteTheme.glassIcon,
                      ),
                    ),
                    SizedBox(
                      width: cardWidth,
                      ...
                      child: _buildWasteCard(
                        ...
                        softBgColor: WasteTheme.metalSoftBg,
                        textColor: WasteTheme.metalColor,
                        icon: WasteTheme.metalIcon,
                      ),
                    ),
                  ],
                );
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  isCompleted ? "(1 GB) Tamamlandı" : "(1 GB)",
                                  style: GoogleFonts.outfit(
                                    fontSize: 11,
                                    fontWeight: FontWeight.bold,
                                    color: isCompleted
